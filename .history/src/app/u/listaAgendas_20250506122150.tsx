...
const agendasMockadas = [
  { id: '1', nome: 'Agenda Clínica' },
  { id: '2', nome: 'Agenda Vacinação' },
  { id: '3', nome: 'Agenda Parto' },
  { id: '4', nome: 'Agenda Inseminação' },
  { id: '5', nome: 'Agenda Consultoria' },
];

interface Props {
  agendasDisponiveis?: { id: string; nome: string }[];
  onConfirmar: (selecionadas: string[]) => void;
}

const TelaSelecaoAgendas: React.FC<Props> = ({
  agendasDisponiveis = agendasMockadas,
  onConfirmar,
}) => {
