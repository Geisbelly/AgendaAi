...
export default class XanoApiAgenda{
  ...
  // Método GET
  public static  getCalendarios = async ({drStart, dtEnd, page, perPage, phone}) => {
    try {
      const uri = this.url+'/calendar/events?dateStart=121&dateEnd=1321&page=1&perPage=100&phoneNumber=45'
  ...
  // Método GET
  public static getEventos = async (endpoint: string) => {
    try {
