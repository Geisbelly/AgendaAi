...
export async function initializeDatabase() {
    const queriesGeral = [
        ...
        -- Essas duas últimas parecem de um modelo diferente (não do Calendario acima),
        -- mas mantive com correções básicas:
        `CREATE TABLE IF NOT EXISTS event_informations (
          id INTEGER PRIMARY KEY,
          title TEXT NOT NULL,
          description TEXT,
          meeting_url TEXT,
          guests TEXT,           -- Array como JSON string
          date_start INTEGER NOT NULL,
          date_end INTEGER NOT NULL,
          duration INTEGER NOT NULL,
          private_file_url TEXT, -- Array como JSON string
          color TEXT
        );`,
